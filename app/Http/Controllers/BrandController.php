...
class BrandController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $query->where('branchName', 'like', "%{$keyword}%");
        })->orWhere('brandName','LIKE',"%{$keyword}%")->paginate(6);
    ...
    public function create()
    {
        ...
        $branch = Branch::all();
        $company = Company::all();
        return view('admin.brand.create',compact(['users'],['company'],['branch']));
    }
    ...
    public function store(Request $request)
    {
        ...
        'brandPicture' => 'required|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
    ...
    public function edit($id)
    {
        ...
        $company = Company::all();
        $branch = Branch::all();
        return view('admin.brand.edit',compact(['brand'],['users'],['company'],['branch']));
    }
