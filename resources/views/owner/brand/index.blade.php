...
@foreach ($brand as $data)
          ...
          <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                @endif
                <span class="username" style="margin-top:6px;"><a href="#">{{$data->brandName}}</a> - <a href="/owner/branch/search?keyword={{$data->branch->branchName}}">{{$data->branch->branchName}}</a>
                </span>
              </div>
              <!-- /.user-block -->
              <!-- /.box-tools -->
        ...
        @if ($data->brandPicture)
                  <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\brand\{{$data->brandPicture}}" width="150" height="150" alt="Photo">
                   </div>
                @else
                <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\no-image.png" width="150" height="150" alt="Photo">
                   </div>
                @endif
                 @if ($data->brandPicture2)
                 <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\brand\{{$data->brandPicture2}}" width="150" height="150" alt="Photo">
                   </div>
                   @else
                <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\no-image.png" width="150" height="150" alt="Photo">
                ...
                @endif
                 ...
                 <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\brand\{{$data->brandPicture3}}" width="150" height="150" alt="Photo">
                   </div>
                   @else
                <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\no-image.png" width="150" height="150" alt="Photo">
                ...
                @endif
                 ...
                 <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\brand\{{$data->brandPicture4}}" width="150" height="150" alt="Photo">
                   </div>
                   @else
                <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\no-image.png" width="150" height="150" alt="Photo">
                ...
                @endif
                 ...
                 <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\brand\{{$data->brandPicture5}}" width="150" height="150" alt="Photo">
                   </div>
                   @else
                <div class="col-md-4">
                   <img class="img-responsive2 brandpicture" src="\images\no-image.png" width="150" height="150" alt="Photo">
              ...
              <form action="/owner/brand/{{$data->brandId}}" method="POST" onSubmit="if(!confirm('Are you sure want to delete this?')){return false;}">
              <a href="/owner/brand/{{$data->brandId}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i> Edit</a>
