...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <a href="/owner/company/unownedcompany">List Unowned Company</a>
    ...
    <section class="content container-fluid">
      ...
      @foreach ($company as $data)
        ...
        <p><b>Phone : </b>{{$data->companyPhone}}</p>
            ...
            <a href="/owner/company/{{$data->companyId}}/edit" type="button" class="btn btn-default btn-xs"><i class="fa fa-share"></i>Edit</a>
              @else

              <form action="/owner/company/{{$data->companyId}}" method="POST" enctype="multipart/form-data" onSubmit="if(!confirm('Are you sure want to claim this?')){return false;}">
              <fieldset>
                  <input class="form-control" type="hidden" name="companyName" placeholder="Nama Perusahaan" value="{{$data->companyName}}">
                  <input class="form-control" type="hidden" name="companyPhone" placeholder="Nomor Handphone" value="{{$data->companyPhone}}">
                  <input class="form-control" type="hidden" name="companyWebsite" placeholder="Website" value="{{$data->companyWebsite}}">
                  <input class="form-control" type="hidden" name="companyEmail" placeholder="Website" value="{{$data->companyEmail}}">
                  <input class="form-control" type="hidden" name="companyNotes" placeholder="companyNotes" value="{{$data->companyNotes}}">
