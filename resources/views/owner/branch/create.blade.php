...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <small><a href="/owner/branch" class="btn btn-default btn-flat">Back</a></small>
      </h1>
    </section>
  ...
  <div class="col-xs-6 col-md-4"></div>
      <div class="col-xs-6 col-md-4">
        <div style="margin-top: 20px;" class="thumbnail">
            <div class="caption">
              <h3>Add Branch</h3>
              <form action="/owner/branch" method="POST" enctype="multipart/form-data">
              <fieldset>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="branchContactName" placeholder="Contact Name">
              <input class="form-control" type="text" name="branchContactNo" placeholder="Phone">
              </div>
              ...
              <div class="form-group">
                <label>News</label>
                <textarea class="form-control" name="branchNews" id="" cols="30" rows="10">Branch News</textarea>
              </div>
...
{{--               <div class="form-group">
                <label>Voucher</label>
                <input type="text" class="form-control" name="branchVoucher" placeholder="Branch Voucher">
              </div> --}}
