  ...
  <div class="modal-dialog">
    ...
    <div id="navbar-top">
      <nav class="navbar navbar-default navbar-static" role="navigation">
        ...
        <div class="col-md-2">
        <div class="dropdown">
          <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-location-arrow" aria-hidden="true"></i> Jakarta
    ...
    <section id="services" class="page">
      <div class="container">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=steak+house">
            <div class="row">
              <div class="col-md-5">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=romantik">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=Hilltop+Restaurant">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=Autenthic+Sunda">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=kopi+shop">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=jepang+restaurant">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=makan+hemat">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=frozen+delight">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/jakarta/search?keyword=street+food">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
          ...
          <div class="col-md-12 cepat">
            ...
            <div class="col-md-2" id="pencarian">
              <a href="#" class="category">
                <img src="jakarta/search?keyword=dessert+cakes" style="height: 48px; width: 48px; display: inline-block;">
                <p>Dessert & Cakes</p>
              </a>
            </div>
            <div class="col-md-2" id="pencarian">
              <a href="jakarta/search?keyword=food+court" class="category">
