  ...
  <div class="modal-dialog">
    ...
    <div id="navbar-top">
      <nav class="navbar navbar-default navbar-static" role="navigation">
        ...
        <div class="col-md-2">
        <div class="dropdown">
          <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-location-arrow" aria-hidden="true"></i> Bandung
    ...
    <section id="services" class="page">
      <div class="container">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=steak+house">
            <div class="row">
              <div class="col-md-5">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=romantik">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=Hilltop+Restaurant">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=Autenthic+Sunda">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=kopi+shop">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=jepang+restaurant">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=makan+hemat">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=frozen+delight">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
        ...
        <div class="ui fluid card">
          <a href="/search?keyword=street+food">
            <div class="row">
              <div class="col-md-5">
                <div class="collection-box-bg" title="Terpopuler Minggu Ini">
