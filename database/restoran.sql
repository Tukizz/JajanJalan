...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Sep 2017 pada 09.27
...
(17, 'Bazer Right', 'Jl. Pahlawan RT 05', 'Dandy', '085646541', 'Bandung', '1504594167.jpg', '2', NULL, '5PM - 4AM', NULL, 'Makan Malam', '9', 'conico', NULL, NULL, '2017-09-04 23:49:27', '2017-09-05 00:27:05');
...
('mdandyc', 'Chris Dandy', 'Cileunyi', 'dandyforze@gmail.com', '1501746932.JPG', 'www.facebook.com/dandforze', 'www.twitter.com', '-', '-', '$2y$10$OZWK3sN0dqfnMdfU.Fh80u7ayHWIIwUbgQH23/K.nSiLq8DEXZ7ce', '-', '-', '8pDvj9RVrRZ9gydBwSrQXNCatbuxnLNaSBT9VHACLBa0brxKZkU9dHE3Gvd2', NULL, '2017-08-29 20:30:13');
...
--
ALTER TABLE `mi_company`
  MODIFY `companyId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
